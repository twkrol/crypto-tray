...
- Automatyczna detekcja języka systemu (polski / angielski)
...
Autostart: wpis pod `HKCU\Software\Microsoft\Windows\CurrentVersion\Run\CryptoTray`. Włączany/wyłączany z menu (nie wymaga praw administratora). Wpis jest automatycznie usuwany przy deinstalacji.
